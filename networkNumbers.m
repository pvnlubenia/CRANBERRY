...
function [model] = networkNumbers(model)
    ...
    Network_Number = ["Species"; "Complexes"; "Reactant complexes"; "Reversible reactions"; "Irreversible reactions"; "Reactions"; "Linkage classes"; "Strong linkage classes"; "Terminal linkage classes"; "Rank"; "Reactant rank"; "Deficiency"; "Reactant deficiency"];
    Symbol = ["m"; "n"; "n_r"; "r_rev"; "r_irrev"; "r"; "l"; "sl"; "t"; "s"; "q"; "delta"; "delta_p"];
    Value = [m; n; n_r; r_rev; r_irrev; r; l; sl; t; s; q; delta; delta_p];
    
    % Combine the columns into a table
    results = table(Network_Number, Symbol, Value);
